...
3. 下载主题
   ...
   # 将主题添加为子模块, clone博客仓库时需加 --recursive 参数拉取所有子模块
   git init
   git submodule add https://github.com/achjqz/hexo-theme-apollo.git themes/apollo
   ```
   > 若使用git clone拉取主题, 则需要删除themes/apollo/.git文件才能使git正常追踪apollo内的文件
